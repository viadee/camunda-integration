...
import de.viadee.camunda.connected.calculator.service.RpaCalculatorService;

@RestController
@RequestMapping("/syncRpa")
public class SyncRpaCalculatorController {

    @Autowired
    private RpaCalculatorService service;
